...
<li> Nault, R., Saha, S., Bhattacharya, S., Dodson, J., Sinha, S., Maiti, T. and  Zacharewski, T. Benchmarking of a Bayesian single cell RNAseq differential gene expression test for dose-response study designs. To appear in the journal of Nucleic Acids Research.  scBT (code for the proposed Bayesian hypothesis testing method) [https://github.com/satabdisaha1288/scBT], spattdr (simulation code) [https://github.com/zacharewskilab/splattdr]</li>
<li> Manuel, C., Sinha, S. and Wang, S. Reduction of bias due to misclassified exposures using instrumental variables.  Accepted to the Canadian Journal of Statistics.
\[[codes/Chris_2021_2022_CJS_mcmc_code_4_m1nm2_4_webpage.R R code]\] for methods M1 and M2. The code for approach M3 using the variational inference is given in the \[[research/Chris_supplementary.pdf Supplementary Materials]\]. \[[codes/bayesmcmc4m3_1.0.tar.gz R package]\] and its \[[codes/bayesmcmc4m3-manual.pdf manual]\] for the MCMC based analysis of method M3.
</li>
...
Journal of the American Statistical Association, 100, 591--601. \[[research/sinha_jasa2005.pdf pdf]\] </li>
...
<a href= "https://arxiv.org/abs/2203.09726">Article</a>, [R package](https://github.com/laozaoer/MMIntAdd)</li>
...
<li> Sinha, S. (2007), Bayesian methods for case-control studies: Annotated bibliography. ISBA Bulletin, 16, 5-8. Complete bulletin. \[[research/ISBA_bulletin0706.pdf pdf]\]
</li>
